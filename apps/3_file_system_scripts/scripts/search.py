...
# Script is at: apps/3_file_system_scripts/scripts/search.py
# Cache is at: .kalshi_cache/ (at project root)
# Path navigation from script file:
#   Path(__file__).resolve() = absolute path to search.py
#   .parent = scripts/
#   .parent.parent = 3_file_system_scripts/
#   .parent.parent.parent = apps/
#   .parent.parent.parent.parent = beyond-mcp/ (project root)
SCRIPT_FILE = Path(__file__).resolve()  # Resolve to absolute path first!
PROJECT_ROOT = SCRIPT_FILE.parent.parent.parent.parent  # Navigate to project root
